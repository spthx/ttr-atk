...
export const WIND_CONDITIONS: Record<WindType, WindCondition> = {
  TAILWIND_PLAYER: {
    ...
    title: '【自社追い風】商機到来',
    directionLabel: '東風 (自社買収推力 +15%)',
    arrowDirection: 'left', // Pushing left towards victory
    playerMultiplier: 1.15,
    enemyMultiplier: 1.0,
    speedMultiplier: 1.0,
    strengthStars: 5,
    description: '自社の交信・交渉力が好調。出資による押し出し力が15%上昇中。',
  ...
  TAILWIND_ENEMY: {
    type: 'TAILWIND_ENEMY',
    title: '【競合追い風】防衛強化',
    directionLabel: '北風（競合防衛力 +20%）',
    arrowDirection: 'right',
    playerMultiplier: 1.0,
    enemyMultiplier: 1.2,
    speedMultiplier: 1.0,
    strengthStars: 4,
    description: '競合に後援が到着。相手の防衛出資の効きが20%上昇中。',
  ...
  CROSSWIND: {
    type: 'CROSSWIND',
    title: '【乱旋風】値動きが活発',
    directionLabel: '旋風（ゲージ速度 1.25倍）',
    arrowDirection: 'spin',
    playerMultiplier: 1.05,
    enemyMultiplier: 1.05,
    speedMultiplier: 1.25,
    strengthStars: 5,
    description: '相場が活発化。双方の出資でゲージが少し速く動く展開。',
